               ...
               <div class="row">
                  ...
                  <div class="col-lg-4 col-sm-6">
                     <div class="tp-category-main-box mb-25 p-relative fix" data-bg-color="#F3F5F7">
                        ...
                        <div class="tp-category-main-content">
                           <h3 class="tp-category-main-title">
                              <a href="shop.php">Desktop Computer</a>
                           </h3>
                  ...
                  <div class="col-lg-4 col-sm-6">
                     <div class="tp-category-main-box mb-25 p-relative fix" data-bg-color="#F3F5F7">
                        ...
                        <div class="tp-category-main-content">
                           <h3 class="tp-category-main-title">
                              <a href="shop.php">Bluetooth Earphones</a>
                           </h3>
                  ...
                  <div class="col-lg-4 col-sm-6">
                     <div class="tp-category-main-box mb-25 p-relative fix" data-bg-color="#F3F5F7">
                        ...
                        <div class="tp-category-main-content">
                           <h3 class="tp-category-main-title">
                              <a href="shop.php">Wireless Headphones</a>
                           </h3>
                  ...
                  <div class="col-lg-4 col-sm-6">
                     <div class="tp-category-main-box mb-25 p-relative fix" data-bg-color="#F3F5F7">
                        ...
                        <div class="tp-category-main-content">
                           <h3 class="tp-category-main-title">
                              <a href="shop.php">Gaming Console</a>
                           </h3>
                  ...
                  <div class="col-lg-4 col-sm-6">
                     <div class="tp-category-main-box mb-25 p-relative fix" data-bg-color="#F3F5F7">
                        ...
                        <div class="tp-category-main-content">
                           <h3 class="tp-category-main-title">
                              <a href="shop.php">Smart Phones</a>
                           </h3>
               ...
               <div class="row">
                  <div class="col-xl-12">
                     ...
                     <div class="tp-category-main-more text-center">
                        <a href="shop.php" class="tp-load-more-btn">
                           Load More 
